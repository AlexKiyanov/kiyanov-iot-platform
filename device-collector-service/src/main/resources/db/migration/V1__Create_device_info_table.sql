-- Создание таблицы device_info для DCS
...
COMMENT ON COLUMN device_info.meta IS 'Дополнительные метаданные устройства в формате JSON';
COMMENT ON COLUMN device_info.created_at IS 'Время создания записи в базе данных';
COMMENT ON COLUMN device_info.updated_at IS 'Время последнего обновления записи в базе данных';
