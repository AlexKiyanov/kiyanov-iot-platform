-- Создание базы данных для Device Collector Service Shard 1
CREATE DATABASE dcs_shard1;

-- Подключение к базе данных dcs_shard1
\c dcs_shard1;
...
COMMENT ON TABLE device_info IS 'Информация об устройствах IoT платформы (Shard 1)';
