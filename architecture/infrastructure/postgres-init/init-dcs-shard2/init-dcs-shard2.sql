-- Создание базы данных для Device Collector Service Shard 2
CREATE DATABASE dcs_shard2;

-- Подключение к базе данных dcs_shard2
\c dcs_shard2;
...
COMMENT ON TABLE device_info IS 'Информация об устройствах IoT платформы (Shard 2)';
